...
def send_message(body, info_dict):
    ...
    message = client.messages.create( to = info_dict['your_num'], from_ = info_dict['trial_num'], body= "Intrusion Detected")
...
#cap = cv2.VideoCapture("D:/College/CN Lab/IDS/Intruder_Detector/refvid.mp4")
...
with open("D:\College\CN Lab\IDS\Intruder_Detector\credentials.txt", 'r') as myfile:
  data = myfile.read()
